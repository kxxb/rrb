...
//////////////////////////////////////////////////////////////////////////////
 ...
 function bulk_sync($P_APARTMENT_ID) {
     $p_date_rec =date("Y-m-d H:i:s");
        ...
        */
        ...
        $o_meesage = 'Комплекс'. $P_APARTMENT_ID.' на сайте.<br>';
        
  }

  
  function all_coplexx(){
      $v_out ="";
      $apartments = rrb_apartment::find('all');
      foreach($apartments as $apartment ) 
              $v_out .= bulk_sync( $apartment->id);
  }
