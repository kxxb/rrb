...
$p_connect, $p_id, $p_complex_name, $p_last_user_id, $p_date_rec, $p_last_user_id, $p_date_rec, $p_mode) {
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_apartment_comlex(?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
    mysqli_stmt_bind_param($stmt, "isiss", $p_id, $p_complex_name, $p_last_user_id, $p_date_rec, $p_last_user_id, $p_date_rec, $p_mode
    );
...
$p_connect, $p_id, $p_name, $p_corpse_number, $p_apartment_coplex_id, $p_last_user_id, $p_date_rec, $p_last_user_id, $p_date_rec, $p_mode) {
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_housing(?,?,?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
    mysqli_stmt_bind_param($stmt, "issiiss", $p_id, $p_name, $p_corpse_number, $p_apartment_coplex_id, $p_last_user_id, $p_date_rec, $p_last_user_id, $p_date_rec, $p_mode
    );
    if ($results_insupdhndb = mysqli_stmt_execute($stmt)) {
        mysqli_stmt_close($stmt);
    } else {
...
$p_connect, $p_id, $p_last_user_id, $p_date_rec, $p_comercial_available, $p_commercial_area, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode) {
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_housing_commercial(?,?,?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
    mysqli_stmt_bind_param($stmt, "iisisis", $p_id, $p_last_user_id, $p_date_rec, $p_comercial_available, $p_commercial_area, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode
    );
    if ($results_insupdhndb = mysqli_stmt_execute($stmt)) {
        mysqli_stmt_close($stmt);
    } else {
...
$p_connect, $p_id, $p_last_user_id, $p_date_rec, $p_total_area_all_flats, $p_total_area_studio, $p_total_area_1rooms, $p_total_area_2rooms, $p_total_area_3rooms, $p_total_area_4rooms, $p_total_area_5rooms, $p_total_area_6rooms, $p_avg_area_studio, $p_min_area_studio, $p_max_area_studio, $p_min_area_st_wo_unheat, $p_max_area_st_wo_unheat, $p_avg_area_1r, $p_min_area_1r, $p_max_area_1r, $p_min_area_1r_wo_unheat, $p_max_area_1r_wo_unheat, $p_avg_area_2r, $p_min_area_2r, $p_max_area_2r, $p_min_area_2r_wo_unheat, $p_max_area_2r_wo_unheat, $p_avg_area_3r, $p_min_area_3r, $p_max_area_3r, $p_min_area_3r_wo_unheat, $p_max_area_3r_wo_unheat, $p_avg_area_4r, $p_min_area_4r, $p_max_area_4r, $p_min_area_4r_wo_unheat, $p_max_area_4r_wo_unheat, $p_avg_area_5r, $p_min_area_5r, $p_max_area_5r, $p_min_area_5r_wo_unheat, $p_max_area_5r_wo_unheat, $p_avg_area_6r, $p_min_area_6r, $p_max_area_6r, $p_min_area_6r_wo_unheat, $p_max_area_6r_wo_unheat, $p_avg_area_n_room, $p_min_area_n_room, $p_max_area_n_room, $p_min_area_n_wo_unheat, $p_max_area_n_wo_unheat, $p_total_area_n_rooms, $p_total_count_all_flats, $p_total_count_studio, $p_total_count_1_rooms, $p_total_count_2_rooms, $p_total_count_3_rooms, $p_total_count_4_rooms, $p_total_count_5_rooms, $p_total_count_6_rooms, $p_total_count_n_rooms, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode) {
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_housing_flat_info(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
...
$p_connect, $p_id, $p_last_user_id, $p_date_rec, $p_type_of_infrastructure_id, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode) {
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_housing_infrastructure(?,?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
    mysqli_stmt_bind_param($stmt, "iisiis", $p_id, $p_last_user_id, $p_date_rec, $p_type_of_infrastructure_id, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode
    );
    if ($results_insupdhndb = mysqli_stmt_execute($stmt)) {
        mysqli_stmt_close($stmt);
    } else {
...
function uid_rrb_housing_specification(
$p_connect, $p_id, $p_number_of_sections, $p_type_of_building, $p_total_land_area, $p_total_floor_area, $p_land_area_build, $p_bearing_material_tech, $p_wall_material, $p_proj_doc_type, $p_serial_number, $p_min_floors, $p_max_floors, $p_floors_type_id, $p_consumer_class_id, $p_economy_class_house_id, $p_ceiling_height, $p_finishing_flats_id, $p_finishing_level_id, $p_common_area_finishing_id, $p_glazed_loggia_id, $p_parking_type_id, $p_num_of_parking_place, $p_num_of_Elevator, $p_estimated_cost_construction, $p_territory_fencing_id, $p_security_id, $p_last_user_id, $p_date_rec, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode) {
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_housing_specification(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
    mysqli_stmt_bind_param($stmt, "iiisssiiisiiiiisiiiiisssiiisis", $p_id, $p_number_of_sections, $p_type_of_building, $p_total_land_area, $p_total_floor_area, $p_land_area_build, $p_bearing_material_tech, $p_wall_material, $p_proj_doc_type, $p_serial_number, $p_min_floors, $p_max_floors, $p_floors_type_id, $p_consumer_class_id, $p_economy_class_house_id, $p_ceiling_height, $p_finishing_flats_id, $p_finishing_level_id, $p_common_area_finishing_id, $p_glazed_loggia_id, $p_parking_type_id, $p_num_of_parking_place, $p_num_of_Elevator, $p_estimated_cost_construction, $p_territory_fencing_id, $p_security_id, $p_last_user_id, $p_date_rec, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode
    );
    if ($results_insupdhndb = mysqli_stmt_execute($stmt)) {
        mysqli_stmt_close($stmt);
    } else {
...
$p_connect, $p_id, $p_last_user_id, $p_date_rec, $p_bank_id, $p_rrb_housing_id, $p_date_rec, $p_mode
    ...
    $v_result = "";
    $query_ui = "CALL rrb.uid_rrb_ipoteka_banks(?,?,?,?,?,@output);";
    $p_connect->query("SET NAMES 'utf8'");
    $stmt = $p_connect->prepare($query_ui);
    mysqli_stmt_bind_param($stmt, "iisiis", $p_id, $p_last_user_id, $p_date_rec, $p_bank_id, $p_rrb_housing_id, $p_last_user_id, $p_date_rec, $p_mode
    );
    if ($results_insupdhndb = mysqli_stmt_execute($stmt)) {
        mysqli_stmt_close($stmt);
    } else {
