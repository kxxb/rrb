    ...
    $query = "SELECT
     ...
     //$connection = conn();
        ...
        while (mysqli_stmt_fetch($stmt)) {
            ...
            $k = get_housing_key($p_connect, $a, $v_ADDRESS);
              ...
              $v_result = uid_rrb_housing_address($p_connect, 
                      ...
                      $v_CADASTRE_NUM, $p_last_user_id, $p_date_rec, $v_Railway_station,
                      $v_Subway_station, $p_mode);
    ...
    $query = "
     ...
     //$connection = conn();
        ...
        while (mysqli_stmt_fetch($stmt)) {
            ...
            $p_state_id = get_hndb_key($p_connect, 925, $v_state);
            $a = get_suragat_key($p_connect, $v_komplex, $p_state_id, $v_city);
            $k = get_housing_key($p_connect, $a, $v_addres);
